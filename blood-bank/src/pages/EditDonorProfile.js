...
import { updateDonorProfile, viewDonorProfile } from '../Store/Actions/action'
    ...
    <form onSubmit={ updateHandler }>
        <Box>
          ...
          <TextField  name="city" value={donorCredentials.city || ""} onChange={changeHandler} required label="Current city" sx={{marginLeft:"15%",marginTop:"5%",width:"70%"}}/>
                {/* <TextField type="text"  name="bloodGroup" value={donorCredentials.bloodGroup} onChange={changeHandler} required label="Blood Group" sx={{marginLeft:"15%",marginTop:"10%",width:"70%"}}/> */}
          ...
          <FormControl sx={{width:"70%", marginTop:"5%", marginLeft:"15%"}}>
                ...
                {/* <TextField type="radio"  name="gender" value={donorCredentials.gender} onChange={changeHandler} required label="Gender" sx={{marginLeft:"15%",marginTop:"10%",width:"70%"}}/> */}
                <FormControl>
                ...
                <TextField type="string"  name="lastDonateDate" value={donorCredentials.lastDonateDate || ""} onChange={changeHandler} required label="Last Donated Date" sx={{marginLeft:"15%",marginTop:"5%",width:"70%"}}/>
                {/* <TextField  name="allergies" value={donorCredentials.allergies} onChange={changeHandler} required label="Any allergies" sx={{marginLeft:"15%",marginTop:"5%",width:"70%"}}/>
                <TextField  name="disease" value={donorCredentials.disease} onChange={changeHandler} required label="Any disease" sx={{marginLeft:"15%",marginTop:"5%",width:"70%"}}/> */}
